...
<a
    ...
    className="relative inline-flex items-center justify-center p-4 sm:px-8 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-purple-500 rounded-lg shadow-md group w-full sm:w-64"
>
    ...
    <span className="relative invisible">Register</span>
            ...
            <div className="font-bold flex justify-center -ml-8 w-full gap-20">
                <Btn2
                    name="Discord"
                    link="https://discord.gg/hackunited"
                    onClick={() => {}}
                    className="w-10"
                />
                <Btn2
                ...
                <Btn2
                    name="Donate"
                    link="https://hcb.hackclub.com/donations/start/hackunited"
                    onClick={() => {}}
                    className="w-10"
                />
            </div>
